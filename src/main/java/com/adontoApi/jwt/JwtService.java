...
public class JwtService {
	...
	//private static final String SECRET_KEY = "r6qj18FqDD3j9mn8szcO8hChvF+PbzoXOzVcYzDweZ9E4Mg0+Gp7WjEGG6k7kZvX22qf8O8PTfKgoY/3s4NcSQ==";
    ...
    public String generateToken(
            Map<String, Object> extraClaims, String username) {
        return Jwts
                .builder()
